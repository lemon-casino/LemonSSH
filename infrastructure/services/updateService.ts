...
const GITHUB_API_URL = 'https://api.github.com/repos/lemon-casino/LemonSSH/releases/latest';
const RELEASES_PAGE_URL = 'https://github.com/lemon-casino/LemonSSH/releases';
