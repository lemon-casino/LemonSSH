...
// store: the master key verifier, convergent replicas and baselines,
// per-provider snapshots/state and history. Forgetting the master key
// removes all of them so the next sync run starts from scratch.
