...
export const enCoreMessages: Messages = {
  ...
  'settings.habits.title': 'Habits',
  'settings.habits.layout': 'Layout mode',
  'settings.habits.layout.desc': 'Choose the classic layout (tabs on top, nav on the left) or the workbench layout (nav in the menu bar, sessions on the left).',
  'settings.habits.layout.classic': 'Classic',
  'settings.habits.layout.workbench': 'Workbench',
  'workbench.tree.newSession': 'New session',
  'workbench.tree.empty': 'No open sessions. Connect a host or open a local terminal to get started.',
  'workbench.tree.section.ungrouped': 'Ungrouped',
  'workbench.tree.section.local': 'Local terminals',
  'workbench.tree.section.workspaces': 'Workspaces',
  'workbench.tree.section.logs': 'Logs',
  'workbench.tree.section.editors': 'Editors',
  'workbench.tree.section.others': 'Others',
  'settings.habits.closeBehavior': 'Close behavior',
  'settings.habits.closeBehavior.desc': 'Choose whether the window close button minimizes to the tray or quits the app. If unset, LemonSSH asks once.',
  'settings.habits.closeBehavior.ask': 'Ask each time',
  'settings.habits.closeBehavior.minimize': 'Minimize to tray',
  'settings.habits.closeBehavior.quit': 'Quit the app',
  'closeBehavior.title': 'Close window',
  'closeBehavior.message': 'Minimize to the tray, or quit the app? This choice is remembered and can be changed later in Settings > Habits.',
  ...
  'settings.appLock.disableDescription': 'Enter the current lock password to stop locking Netcatty. The saved password will be removed; turning App Lock on again requires creating a new one.',
  ...
  'settings.appLock.setupPasswordDescription': 'This password is required to unlock Netcatty and to change or turn off App Lock later.',
  ...
  'settings.appLock.systemUnlock.desc': 'Use {label} as an alternate way to unlock Netcatty on this device.',
