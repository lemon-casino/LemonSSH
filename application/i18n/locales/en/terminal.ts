...
export const enTerminalMessages: Messages = {
  ...
  'cloudSync.unlock.forgotConfirmDesc': 'Resetting cloud sync removes the saved master key, replicas, baselines and provider connections. Your local vault data is untouched, but the next sync starts from scratch with a new master key. This cannot be undone.',
