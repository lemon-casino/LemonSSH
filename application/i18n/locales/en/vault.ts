...
export const enVaultMessages: Messages = {
  ...
  'pf.type.dynamic.desc': 'Dynamic port forwarding turns LemonSSH into a SOCKS proxy server.',
  ...
  'settings.osProtocol.title': 'URL protocol handoff',
  'settings.osProtocol.enable': 'Open ssh:// and telnet:// links with LemonSSH',
  'settings.osProtocol.enableDesc': 'Registers the ssh://, telnet:// and netcatty:// schemes for the current user so links from browsers and other apps open in LemonSSH. Writes only HKCU\\Software\\Classes; no administrator rights required.',
  ...
  'hostDetails.proxyPanel.test': 'Test connectivity',
  'hostDetails.proxyPanel.test.testing': 'Testing…',
  'hostDetails.proxyPanel.test.ok': 'Proxy reachable ({ms} ms)',
  'hostDetails.proxyPanel.test.failed': 'Proxy test failed: {error}',
