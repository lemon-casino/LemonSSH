...
export const zhCNCoreMessages: Messages = {
  ...
  'settings.tab.habits': '个人习惯',
  'settings.habits.title': '个人习惯',
  'settings.habits.layout': '布局模式',
  'settings.habits.layout.desc': '选择经典布局（顶栏标签页 + 左侧导航）或工作台布局（菜单栏 + 左侧会话树）。',
  'settings.habits.layout.classic': '经典布局',
  'settings.habits.layout.workbench': '工作台布局',
  'workbench.tree.newSession': '新建会话',
  'workbench.tree.empty': '暂无打开的会话。连接主机或打开本地终端即可开始。',
  'workbench.tree.section.ungrouped': '未分组',
  'workbench.tree.section.local': '本地终端',
  'workbench.tree.section.workspaces': '工作区',
  'workbench.tree.section.logs': '日志',
  'workbench.tree.section.editors': '编辑器',
  'workbench.tree.section.others': '其他',
  'settings.habits.closeBehavior': '关闭方式',
  'settings.habits.closeBehavior.desc': '点击窗口关闭按钮时最小化到托盘，还是直接退出程序。未选择时会询问一次。',
  'settings.habits.closeBehavior.ask': '每次询问',
  'settings.habits.closeBehavior.minimize': '最小化到托盘',
  'settings.habits.closeBehavior.quit': '直接关闭程序',
  'closeBehavior.title': '关闭窗口',
  'closeBehavior.message': '要最小化到托盘，还是直接关闭程序？这次选择会记住，之后可在设置 > 个人习惯里更改。',
  'closeBehavior.minimize': '最小化',
  'closeBehavior.quit': '直接关闭',
