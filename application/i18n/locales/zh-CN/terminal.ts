...
export const zhCNTerminalMessages: Messages = {
  ...
  'settings.osProtocol.title': '系统协议接管',
  'settings.osProtocol.enable': '用 LemonSSH 打开 ssh:// 和 telnet:// 链接',
  'settings.osProtocol.enableDesc': '为当前用户注册 ssh://、telnet://、netcatty:// 协议，浏览器和其他应用中的链接将用 LemonSSH 打开。仅写入当前用户注册表，无需管理员权限。',
  ...
  'settings.terminal.behavior.disconnectedNotice.desc': '已连接的会话断开后，可在终端内显示简短提示，或继续使用完整弹窗。首次连接失败仍使用弹窗。',
  'settings.terminal.behavior.disconnectedNotice.terminal': '终端内提示',
  'settings.terminal.behavior.disconnectedNotice.dialog': '弹窗提示',
  ...
  'hostDetails.proxyPanel.test': '测试连通性',
  'hostDetails.proxyPanel.test.testing': '测试中…',
  'hostDetails.proxyPanel.test.ok': '代理可达（{ms} ms）',
  'hostDetails.proxyPanel.test.failed': '代理测试失败：{error}',
  ...
  'keychain.import.dropHint': '将密钥文件拖到这里。可一次多选私钥和对应的 .pub，自动识别并归成一组。',
