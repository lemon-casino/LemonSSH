...
export const zhCNVaultMessages: Messages = {
  ...
  'notes.toolbar.modeLive': '实时预览',
  'notes.toolbar.modeLiveTitle': '实时预览模式 (WYSIWYG)',
  'notes.toolbar.modeSource': '源码模式',
  'notes.toolbar.modeSourceTitle': '源码模式 (Markdown 代码)',
  'notes.toolbar.modePreview': '阅读模式',
  'notes.toolbar.modePreviewTitle': '阅读模式 (只读排版)',
  'notes.toolbar.undo': '撤销 (Ctrl+Z)',
  'notes.toolbar.redo': '重做 (Ctrl+Y)',
  'notes.toolbar.typography': '代码字体与排版设置',
  'notes.toolbar.customCodeFont': '自定义代码字体',
  'notes.toolbar.fontsAvailable': '共 {count} 款可用字体',
  'notes.toolbar.searchFont': '搜索字体...',
  'notes.toolbar.noFontsFound': '未找到匹配的等宽字体',
  'notes.toolbar.defaultFont': '默认等宽字体 (Default)',
  'notes.toolbar.bodyFontSize': '正文字号',
  'notes.toolbar.codeFontSize': '代码字号',
  'notes.toolbar.headingLevel': '标题层级',
  'notes.toolbar.h1': '一级标题',
  'notes.toolbar.h2': '二级标题',
  'notes.toolbar.h3': '三级标题',
  'notes.toolbar.h4': '四级标题',
  'notes.toolbar.bold': '加粗 (Ctrl+B)',
  'notes.toolbar.italic': '斜体 (Ctrl+I)',
  'notes.toolbar.strikethrough': '删除线',
  'notes.toolbar.underline': '下划线',
  'notes.toolbar.inlineCode': '行内代码',
  'notes.toolbar.bulletList': '无序列表',
  'notes.toolbar.orderedList': '有序列表',
  'notes.toolbar.taskList': '待办任务清单',
  'notes.toolbar.quote': '引用块',
  'notes.toolbar.codeBlock': '代码块',
  'notes.toolbar.mathFormula': '数学公式块 (LaTeX / Math)',
  'notes.toolbar.table': '插入表格',
  'notes.toolbar.divider': '分割线',
  'notes.toolbar.link': '插入超链接',
  'notes.toolbar.image': '插入图片',
  'notes.action.pin': '置顶笔记',
  'notes.action.unpin': '取消置顶',
  'notes.tag.remove': '移除标签',
  'notes.tag.placeholder': '标签名...',
  'notes.tag.add': '添加标签',
  'notes.outline.title': '大纲目录',
  'notes.outline.titleWithCount': '大纲目录 ({count})',
  'notes.outline.empty': '暂无标题大纲',
  'notes.outline.emptyHint': '在 Markdown 中使用 #、## 编写各级标题',
  'notes.export.share': '导出与分享',
  'notes.export.currentNote': '当前笔记',
  'notes.export.exportMarkdown': '导出为 Markdown (.md)',
  'notes.export.exportHtml': '导出为 HTML (.html)',
  'notes.export.copyMarkdown': '复制 Markdown 源码',
  'notes.export.allNotes': '全部笔记',
  'notes.export.exportAllZip': '导出全部为 ZIP 压缩包',
  'notes.export.toast.markdownSuccess': '已导出 Markdown 文件',
  'notes.export.toast.htmlSuccess': '已导出 HTML 文件',
  'notes.export.toast.zipSuccess': '已导出全部笔记备份 ZIP',
  ...
  'selectHost.toggleGroup': '切换分组 {name} 下的全部主机',
  'selectHost.toggleHost': '切换 {name}',
  ...
  'hostDetails.sftp.fileProtocol': '文件协议',
  'hostDetails.sftp.fileProtocol.desc': '自动优先 SFTP；当服务器无 SFTP 子系统时回退到 SCP 模式（如部分 NAS）。仅支持 SCP 的主机可强制 SCP。',
  'hostDetails.sftp.fileProtocol.auto': '自动',
  'hostDetails.sftp.fileProtocol.sftp': '仅 SFTP',
  ...
  'hostDetails.auth.method': '登录方式',
  'hostDetails.auth.auto': '自动选择',
  'hostDetails.auth.auto.desc': '先尝试系统密钥和本地密钥，最后使用已保存的密码。',
  'hostDetails.auth.passwordOnly': '仅密码',
  'hostDetails.auth.password.desc': '只使用已保存的密码和交互式密码提示。',
  'hostDetails.auth.key': '密钥',
  ...
  'hostDetails.section.systemSshAgent': '系统 SSH 密钥',
  'hostDetails.systemSshAgent': '使用系统 SSH 密钥登录',
  'hostDetails.systemSshAgent.desc': '使用已由 macOS、Linux、Windows、1Password 或其他兼容服务解锁的密钥',
  'hostDetails.systemSshAgent.socket': '代理地址',
  'hostDetails.systemSshAgent.socket.desc': '留空时使用 SSH_AUTH_SOCK',
  'hostDetails.systemSshAgent.identitiesOnly': '仅使用已配置的密钥',
  'hostDetails.systemSshAgent.identitiesOnly.desc': '不尝试代理中其他无关密钥',
  'hostDetails.systemSshAgent.notRunning': '系统 SSH 密钥服务不可用',
  'hostDetails.systemSshAgent.notRunningHint': '请启动或解锁密钥服务，或者在上方填写它的地址。',
  ...
  'hostDetails.plugin.title': '插件连接',
  'hostDetails.plugin.provider.placeholder': '选择连接提供程序',
  'hostDetails.plugin.provider.empty': '未安装连接提供程序',
  'hostDetails.plugin.authentication.placeholder': '选择认证提供程序',
  'hostDetails.plugin.authentication.none': '由提供程序管理或无需认证',
  'hostDetails.plugin.credential.placeholder': '选择宿主管理的凭据',
  'hostDetails.plugin.credential.none': '不使用已保存凭据',
  'hostDetails.plugin.credential.password': '密码身份',
  'hostDetails.plugin.credential.privateKey': '私钥',
  'hostDetails.plugin.credential.unavailable': '已保存的凭据不可用',
  'hostDetails.plugin.configuration.label': '提供程序配置（JSON）',
  'hostDetails.plugin.configuration.invalid': '配置必须是有效的 JSON。',
  'hostDetails.plugin.configuration.schemaInvalid': '配置不符合提供程序声明的结构。',
  'hostDetails.plugin.unavailable': '当前配置的提供程序不可用；重新安装插件前将保留配置。',
  ...
  'terminal.paneMagnification.magnify': '放大当前面板',
  'terminal.paneMagnification.restore': '还原面板布局',
  ...
  'terminal.statusbar.disconnect.label': '断开连接',
  'terminal.statusbar.disconnect.tooltip': '断开当前会话，但保留标签页',
  'terminal.statusbar.reconnect.label': '重新连接',
  ...
  'cloudSync.gate.warning':
    '我已了解：请妥善保存主密钥和 OAuth 应用 client ID。忘记主密钥时可使用「重置初始化」重新开始；本地保险库数据不会被删除，但已保存的 client ID、服务商连接和云同步身份会被清除，之后需要重新粘贴 client ID。',
  'cloudSync.gate.enableVault': '启用加密保险库',
  'cloudSync.gate.enabledToast': '已启用加密保险库',
  ...
  'cloudSync.connect.plugin.success': '插件同步提供方已连接',
  'cloudSync.connect.plugin.failedTitle': '插件同步连接失败',
  'cloudSync.pluginConfig.title': '配置 {name}',
  'cloudSync.pluginConfig.desc': '请输入该插件同步提供方所需的 JSON 配置。',
  'cloudSync.pluginConfig.label': '提供方配置（JSON）',
  'cloudSync.pluginConfig.invalidJson': '配置必须是有效的 JSON。',
  'cloudSync.pluginConfig.schemaInvalid': '配置不符合提供方声明的结构。',
  ...
  'cloudSync.convergent.title': '可收敛多设备同步',
  'cloudSync.convergent.experimental': '实验性',
  ...
  'cloudSync.convergent.preview.providers': '云服务',
  'cloudSync.convergent.preview.conflicts': '冲突',
  'cloudSync.convergent.preview.compatibility': '每个加密载荷仍保留完整 v1 快照，供旧客户端读取。',
  'cloudSync.convergent.preview.confirm': '创建 CRDT 副本',
  'cloudSync.convergent.preview.status.ready': '就绪',
  'cloudSync.convergent.preview.status.empty': '为空',
  'cloudSync.convergent.preview.status.unavailable': '不可用',
  'cloudSync.convergent.preview.status.blocked': '已阻断',
  'cloudSync.convergent.preview.schema': '协议版本',
  'cloudSync.convergent.field.presence': '存在状态',
  'cloudSync.convergent.field.position': '排序位置',
  'cloudSync.convergent.conflicts.title': '字段冲突（{count}）',
  'cloudSync.convergent.conflict.empty': '为空 / 已删除',
  'cloudSync.convergent.conflict.secretSet': '秘密值已设置',
  'cloudSync.convergent.conflict.current': '当前候选',
  'cloudSync.convergent.conflict.choose': '选择',
  'cloudSync.convergent.conflict.resolved': '冲突已解决并同步',
  'cloudSync.convergent.downgrade.desc': '将所有已连接云服务中的 v2 文件替换为旧版快照。',
  'cloudSync.convergent.downgrade.button': '降级',
  'cloudSync.convergent.downgrade.confirm': '确定将所有已连接云服务降级为旧版同步吗？写后验证通过后会移除 CRDT 元数据。',
  'cloudSync.convergent.downgrade.done': '可收敛同步已降级',
  ...
  'cloudSync.changeKey.desc': '这将重新加密保险库，请务必记住新的主密钥。',
  ...
  'cloudSync.unlock.failed': '解锁保险库失败',
  'cloudSync.unlock.showKey': '显示主密钥',
  'cloudSync.unlock.notNow': '暂不',
  'cloudSync.unlock.readyToast': '保险库已就绪',
  'cloudSync.unlock.unlockButton': '解锁',
  'cloudSync.header.vaultReady': '保险库已就绪',
  'cloudSync.header.preparingVault': '正在准备保险库...',
  ...
  'cloudSync.oauth.guideTitle': '填写指导',
  'cloudSync.oauth.guide.github': 'GitHub：Settings → Developer settings → OAuth Apps → New，或 GitHub App。名称和首页随意，不需要重定向 URI，并启用设备流（OAuth App 在页面底部勾选；GitHub App 在应用 General 设置里开启）。创建后把 Client ID 粘贴到这里。',
  'cloudSync.oauth.guide.google': '1. console.cloud.google.com 打开同一项目。\n2. 库 → 启用 Google Drive API。\n3. OAuth 同意屏幕保持测试；Audience 里把你的 Gmail 加成测试用户。\n4. Data Access 添加范围：drive.appdata、userinfo.email、userinfo.profile。\n5. 凭据 → 创建 OAuth 客户端 ID → 类型选「桌面应用」。\n6. 把 Client ID 填到上面；把下载 JSON 里的 client_secret（GOCSPX-）填到下面的密钥框。\n7. 从 LemonSSH 重新点连接，不要刷新旧的 127.0.0.1 回调页。',
  'cloudSync.oauth.guide.onedrive': 'OneDrive：Azure Portal → 应用注册 → 新注册 → 类型选「公共客户端/本机」，重定向 URI 填 http://localhost，并在身份验证里开启「允许公共客户端流」。粘贴 Application (client) ID。',
  'cloudSync.unlock.forgotLink': '忘记主密钥？',
  'cloudSync.unlock.forgotConfirmDesc': '重置云同步会删除已保存的主密钥、副本、基线、各服务商连接和 OAuth 应用 client ID。本地保险库数据不受影响，但下次同步将以新主密钥从零开始。此操作不可撤销。',
  'cloudSync.unlock.forgotConfirmButton': '重置云同步',
  'cloudSync.unlock.forgotCancel': '保留',
  'cloudSync.unlock.forgotDoneToast': '云同步已重置（清理 {{count}} 项）。设置新的主密钥即可重新开始。',
  'cloudSync.unlock.forgotFailed': '重置云同步失败',
  'cloudSync.resetInit.button': '重置初始化',
  'cloudSync.resetInit.title': '重置云同步？',
  'cloudSync.resetInit.desc': '忘记主密钥？重置云同步会删除其身份信息，之后可用新主密钥重新开始。',
  'cloudSync.resetInit.itemKey': '删除已保存的主密钥及其校验器',
  'cloudSync.resetInit.itemConnections': '删除各服务商连接、副本、基线与快照',
  'cloudSync.resetInit.itemOAuth': '删除已保存的 OAuth 应用 client ID',
  'cloudSync.resetInit.itemLocalSafe': '本地保险库数据不受影响；此操作不可撤销',
  'cloudSync.oauth.sectionDesc': '为使用的每个服务商注册一个「桌面应用」类型的 OAuth 客户端，并把 client ID 粘贴到这里。Google 桌面应用下载的 JSON 里仍有 client_secret，换 token 时需要填写。GitHub 使用 Device Flow；OneDrive 使用本地回环 PKCE。',
  ...
  'cloudSync.oauth.googleSecretHint': '从 Google 下载的桌面应用 JSON 里复制 client_secret（GOCSPX- 开头）。只用于本机换 token，不会上传到云同步。',
  ...
  'cloudSync.clearLocal.dialog.title': '清空本地保险库数据？',
  ...
  'sftp.conflict.folderTitle': '文件夹冲突',
  'sftp.conflict.folderDesc': '请选择处理方式。',
  'sftp.conflict.folderFileDesc': '目标位置已存在同名文件，文件夹无法与文件合并。',
  'sftp.conflict.folderSymlinkDesc': '目标位置已存在同名符号链接，文件夹无法与符号链接合并。',
  'sftp.conflict.folderUnknownDesc': '目标位置已存在同名项目，但无法确认其类型。为保护目标数据，替换操作不可用。',
  'sftp.conflict.folderMergeHint': '合并：保留目标中独有的内容。',
  'sftp.conflict.folderReplaceWarning': '替换：删除目标中独有的内容，且无法恢复。',
  ...
  'vault.import.plugins.title': '插件导入器',
  'vault.import.plugins.loading': '正在生成安全导入预览…',
  'vault.import.plugins.progress': '已处理 {completed}/{total} {message}',
  'vault.import.plugins.preview': '导入预览',
  'vault.import.plugins.empty': '导入器未返回可导入的草稿。',
  'vault.import.plugins.summary': '{parsed} 个草稿 · {warnings} 个警告 · {errors} 个错误',
  'vault.import.plugins.commit': '导入预览内容',
  'vault.import.plugins.fileUnavailable': '桌面导入桥无法访问所选文件。',
  'vault.import.plugins.notRecognized': '此导入器无法识别所选文件。',
  'vault.import.plugins.containsErrors': '导入预览包含错误，无法提交。',
  'vault.import.plugins.committed': '已导入 {count} 个经过验证的项目。',
  'vault.import.plugins.duplicates': '将跳过 {count} 个重复项目。',
  'vault.import.plugins.validationErrors': '{count} 个草稿未通过宿主校验，导入器必须先修复。',
  'vault.import.plugins.kind.host': '主机',
  'vault.import.plugins.kind.identity': '身份',
  'vault.import.plugins.kind.key': '密钥',
  'vault.import.plugins.kind.snippet': '命令片段',
  'vault.import.plugins.kind.group': '分组',
  'vault.import.plugins.moreItems': '本次导入还包含 {count} 个项目。',
  'vault.import.plugins.moreDiagnostics': '预览中省略了另外 {count} 条诊断信息。',
