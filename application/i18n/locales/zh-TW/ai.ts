...
export const zhTWAiMessages: Messages = {
  ...
  'ai.agent.directory': '目錄',
  'ai.agent.selectDirectory': '選擇包含 Agent 執行檔的目錄',
  ...
  'ai.codebuddy.effort.hint': '控制模型推理深度。簡單命令用 Low 節省 token，複雜診斷用 High/XHigh。',
  ...
  'ai.agentApproval.title': 'Agent 審核',
  ...
  'ai.externalMcp.conflict.description': '已存在指向其他位置的 lemonssh-external 項目，請手動刪除或修改。',
