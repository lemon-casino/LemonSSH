...
export const zhTWCoreMessages: Messages = {
  ...
  'confirm.deleteIdentity': '刪除身分 "{name}"？',
  ...
  'dialog.createWorkspace.title': '建立工作區',
  ...
  // App Lock
  'appLock.title': 'Netcatty 已鎖定',
  'appLock.reason.default': '請輸入鎖定密碼以繼續。',
  'appLock.reason.startup': 'Netcatty 會在每次開啟這個視窗時鎖定。',
  'appLock.reason.idle': 'Netcatty 已因閒置逾時而鎖定。',
  'appLock.reason.manual': 'Netcatty 已被手動鎖定。',
  'appLock.passwordLabel': '鎖定密碼',
  'appLock.passwordPlaceholder': '輸入密碼以解鎖',
  'appLock.unlock': '解鎖',
  'appLock.unlocking': '正在解鎖...',
  'appLock.usePassword': '改用密碼解鎖',
  'appLock.error.emptyPassword': '請輸入鎖定密碼。',
  'appLock.error.incorrectPassword': '鎖定密碼不正確。',
  'appLock.systemUnlock.unlockWith': '使用 {label} 解鎖',
  ...
  'appLock.reset.confirm': '重設應用程式鎖定',
  'appLock.reset.resetting': '正在重設...',
  'appLock.reset.error': '無法重設應用程式鎖定，請重試。',
  'topTabs.lockApp': '鎖定 Netcatty',
  ...
  'settings.tab.habits': '個人習慣',
  'settings.habits.title': '個人習慣',
  'settings.habits.layout': '配置模式',
  'settings.habits.layout.desc': '選擇經典配置（頂欄標籤頁 + 左側導航）或工作台配置（功能表列 + 左側會話樹）。',
  'settings.habits.layout.classic': '經典配置',
  'settings.habits.layout.workbench': '工作台配置',
  'workbench.tree.newSession': '新建工作階段',
  'workbench.tree.empty': '尚無開啟的工作階段。連線主機或開啟本地終端機即可開始。',
  'workbench.tree.section.ungrouped': '未分組',
  'workbench.tree.section.local': '本地終端機',
  'workbench.tree.section.workspaces': '工作區',
  'workbench.tree.section.logs': '日誌',
  'workbench.tree.section.editors': '編輯器',
  'workbench.tree.section.others': '其他',
  'settings.habits.closeBehavior': '關閉方式',
  'settings.habits.closeBehavior.desc': '點擊視窗關閉按鈕時最小化到系統匣，還是直接結束程式。未選擇時會詢問一次。',
  'settings.habits.closeBehavior.ask': '每次詢問',
  'settings.habits.closeBehavior.minimize': '最小化到系統匣',
  'settings.habits.closeBehavior.quit': '直接關閉程式',
  'closeBehavior.title': '關閉視窗',
  'closeBehavior.message': '要最小化到系統匣，還是直接關閉程式？這次選擇會記住，之後可在設定 > 個人習慣裡更改。',
  'closeBehavior.minimize': '最小化',
  'closeBehavior.quit': '直接關閉',
  ...
  'settings.appLock.title': '應用程式鎖定',
  'settings.appLock.description': '在 Netcatty 開啟、閒置一段時間或手動鎖定後，要求輸入本機的鎖定密碼。',
  'settings.appLock.setupTitle': '設定鎖定密碼',
  'settings.appLock.setupDescription': '請在下方建立密碼，儲存後會立即啟用應用程式鎖定。',
  'settings.appLock.manageTitle': '應用程式鎖定已就緒',
  'settings.appLock.enabledStatus': '已啟用。Netcatty 會在啟動、閒置逾時以及手動鎖定時要求輸入密碼。',
  'settings.appLock.disabledStatus': '密碼已儲存，但應用程式鎖定目前為關閉。',
  'settings.appLock.disableTitle': '關閉應用程式鎖定',
  'settings.appLock.disableDescription': '輸入目前的鎖定密碼即可停止鎖定 Netcatty。已儲存的密碼會一併移除；日後要再啟用必須重新建立新密碼。',
  'settings.appLock.disable': '關閉應用程式鎖定',
  'settings.appLock.disabling': '正在關閉...',
  'settings.appLock.setupPasswordTitle': '建立鎖定密碼',
  'settings.appLock.setupPasswordDescription': '這組密碼用來解鎖 Netcatty，日後修改或關閉應用程式鎖定時也會用到。',
  'settings.appLock.changePasswordTitle': '修改鎖定密碼',
  'settings.appLock.changePasswordDescription': '先輸入目前的鎖定密碼，再設定新密碼。',
  'settings.appLock.enable': '啟用應用程式鎖定',
  'settings.appLock.enableDesc': '啟動時鎖定，並在達到所選的閒置逾時後鎖定。',
  'settings.appLock.timeout': '閒置逾時',
  'settings.appLock.timeoutDesc': '閒置時鎖定，關閉到系統匣時也會鎖定。選擇「不自動鎖定」則兩者都不會鎖定。',
  'settings.appLock.timeout.0': '不自動鎖定',
  'settings.appLock.timeout.1': '1 分鐘',
  'settings.appLock.timeout.5': '5 分鐘',
  'settings.appLock.timeout.15': '15 分鐘',
  'settings.appLock.timeout.30': '30 分鐘',
  'settings.appLock.timeout.60': '60 分鐘',
  'settings.appLock.systemUnlock.label': '{label} 解鎖',
  'settings.appLock.systemUnlock.desc': '在這台裝置上，使用 {label} 作為解鎖 Netcatty 的另一種方式。',
  'settings.appLock.systemUnlock.unavailableDesc': '這台裝置目前無法使用 {label}。',
  'settings.appLock.systemUnlock.unavailable': '這台裝置目前無法使用系統解鎖。',
  'settings.appLock.systemUnlock.locked': '請先解鎖 Netcatty，再變更系統解鎖設定。',
  'settings.appLock.systemUnlock.autoPrompt.label': '自動開啟 {label}',
  'settings.appLock.systemUnlock.autoPrompt.desc': '當 Netcatty 等待解鎖時，自動顯示 {label} 驗證提示。',
  'settings.appLock.currentPassword': '目前密碼',
  'settings.appLock.currentPasswordPlaceholder': '停用或更換時需要',
  'settings.appLock.currentPasswordForDisablePlaceholder': '用於關閉應用程式鎖定的目前密碼',
  'settings.appLock.currentPasswordForChangePlaceholder': '用於修改密碼的目前密碼',
  'settings.appLock.newPassword': '新密碼',
  'settings.appLock.newPasswordPlaceholder': '設定鎖定密碼',
  'settings.appLock.confirmPassword': '確認密碼',
  'settings.appLock.confirmPasswordPlaceholder': '再次輸入密碼',
  'settings.appLock.savePassword': '設定並啟用',
  'settings.appLock.savingPassword': '正在儲存...',
  'settings.appLock.passwordSet': '密碼已設定',
  'settings.appLock.replacePassword': '更換密碼',
  'settings.appLock.enableAfterPassword': '請先設定鎖定密碼，再啟用應用程式鎖定。',
  'settings.appLock.localOnlyHint': '僅限本裝置的隱私鎖。不會同步，也不是作業系統層級的安全邊界。',
  'settings.appLock.validation.currentRequired': '請輸入目前的鎖定密碼。',
  'settings.appLock.validation.newRequired': '請輸入新的鎖定密碼。',
  'settings.appLock.validation.confirmRequired': '請確認新的鎖定密碼。',
  ...
  'settings.update.restartNow': '重新啟動並更新',
  ...
  'settings.sessionRestore.restorePreviousSession': '恢復上次的分頁和工作區',
  'settings.sessionRestore.restorePreviousSessionDesc': '啟動時重新開啟上次的終端分頁和工作區佈局。',
  ...
  'terminal.restore.placeholder.desc': '此終端目前已斷開。準備好後可以重新連線，為這個分頁啟動新的 shell。',
  ...
  'settings.globalHotkey.title': '全域快速鍵',
  'settings.globalHotkey.toggleWindow': '切換視窗',
  'settings.globalHotkey.toggleWindowDesc': '按下組合鍵以設定顯示/隱藏視窗的全域快速鍵。',
  ...
  'settings.application.reportProblem.subtitle': '產生預填的 GitHub issue',
  ...
  'settings.vault.selectBeforeConnectDesc': '點一下選取主機（網格模式會顯示強調色邊框），再點一下才連線；群組同理。預設仍是點一下直接連線。',
  'settings.vault.showOnlyUngroupedHostsInRoot': '根目錄只顯示未歸類主機',
  'settings.vault.showOnlyUngroupedHostsInRootDesc': '開啟後，主機庫根目錄的主機列表只顯示沒有群組的主機，已歸類的主機請從左側群組進入檢視。',
  ...
  'update.needsSave.message': '請先儲存已開啟的編輯器，然後再次點選「立即重新啟動」以安裝更新。',
...
部分列 / 窗格還支援 \`[data-selected="true"]\`、\`[data-focused="true"]\` 等狀態掛鉤。
...
`,
  ...
  'sync.autoSync.emptyVaultConflict.description': '本機主機庫為空，但雲端有資料。這通常發生在應用程式更新或儲存重設之後。請選擇如何處理：',
  ...
  'proxyProfiles.panel.newTitle': '新增代理',
  ...
  'proxyProfiles.delete.desc': '刪除 "{name}" 會同時從 {count} 個主機或群組設定中解除關聯。',

  'vault.groups.title': '群組',
  'vault.groups.total': '共 {count} 個',
  'vault.groups.hostsCount': '{count} 台主機',
  'vault.groups.newSubgroup': '新增子群組',
  'vault.groups.rename': '重新命名群組',
  'vault.groups.unnamed': '未命名群組',
  'vault.groups.delete': '刪除群組',
  'vault.groups.createSubfolder': '建立子群組',
  'vault.groups.createRoot': '建立根群組',
  'vault.groups.createDialog.desc': '建立新的群組用於組織主機。',
  'vault.groups.renameDialogTitle': '重新命名群組',
  'vault.groups.renameDialog.desc': '重新命名已有群組。',
  'vault.groups.deleteDialogTitle': '刪除群組',
  'vault.groups.deleteDialog.desc': '這將永久刪除該群組並將所有主機移動到根層級。',
  ...
  'vault.groups.deleteDialog.bulkDesc': '這將永久刪除所選群組，並把其中的主機移動到根層級。',
  'vault.groups.deleteDialog.bulkDeleteHosts': '同時刪除所選群組下的所有主機',
  'vault.groups.selectedCount': '已選擇 {count} 個群組',
  'vault.groups.deleteMultiple.success': '已刪除 {count} 個所選項目',
  'vault.groups.ungrouped': '未群組',
  'vault.groups.field.name': '群組名稱',
  'vault.groups.placeholder.example': '例如：Production',
  'vault.groups.parentLabel': '父級',
  'vault.groups.pathLabel': '路徑',
  'vault.groups.settings': '群組設定',
  'vault.groups.details': '群組詳情',
  ...
  'vault.groups.details.parentGroup': '父群組',
  'vault.groups.details.none': '無',
  'vault.groups.details.inherited': '繼承自群組',
  'vault.groups.details.addProtocol': '新增協定',
  'vault.groups.details.removeProtocol': '移除協定',
  'vault.groups.details.fontFamily': '字型',
  'vault.groups.details.fontSize': '字型大小',
  'vault.groups.errors.required': '群組名稱不能為空。',
  'vault.groups.errors.invalidChars': "群組名稱不能包含 '/' 或 '\\\\'.",
  'vault.groups.errors.duplicatePath': '該位置已存在同名群組。',
  ...
  'vault.managedSource.unmanageSuccess': '已取消託管群組',
  ...
  'vault.hosts.copyCredentials': '複製帳密資訊',
  'vault.hosts.copyCredentials.toast.success': '帳密資訊已複製到剪貼簿',
  'vault.hosts.copyCredentials.toast.noPassword': '該主機未儲存密碼',
  'vault.hosts.multiSelect': '多選',
  'vault.hosts.selected': '已選擇 {count} 項',
  'vault.hosts.selectedSummary': '已選擇 {hosts} 個主機和 {groups} 個群組',
  ...
  'vault.import.desc': '從常見工具移轉連線資訊。選擇一種格式開始匯入。',
  'vault.import.chooseFormat': '選擇檔案格式',
  'vault.import.destination.title': '匯入的主機要放到哪裡？',
  'vault.import.destination.preserve': '保留原始群組',
  'vault.import.destination.existing': '選擇現有群組',
  'vault.import.destination.new': '新增群組',
  'vault.import.destination.noGroups': '暫無可選群組',
  'vault.import.destination.newPlaceholder': '輸入新群組名稱',
  'vault.import.destination.settings': '匯入位置',
  'vault.import.destination.settingsHint': '設定主機要放到哪個群組',
  ...
  'vault.import.sshConfig.managedDestinationHint': '託管同步會使用獨立的託管群組；上方目標群組只用於一次性匯入。',
  ...
  'vault.import.sshConfig.alreadyManagedDesc': '該檔案已在群組 "{group}" 下託管。如需重新匯入，請先移除現有的託管源。',
  ...
  'pf.wizard.localConfig.title': '設定本機埠與繫結位址：',
  'pf.wizard.localConfig.desc': '該埠會在本機（目前裝置）開啟，並接收流量。',
  'pf.wizard.localConfig.localPort': '本機埠 *',
  'pf.wizard.bindAddress': '繫結位址',
  'pf.wizard.remoteHost.title': '選擇遠端主機：',
  'pf.wizard.remoteHost.desc': '選擇要開啟埠的遠端主機。該埠的流量將轉發到目標位址。',
  'pf.wizard.remoteConfig.title': '設定埠與繫結位址：',
  'pf.wizard.remoteConfig.desc': '將從所選主機的指定埠與網路卡位址轉發流量。',
  'pf.wizard.remoteConfig.remotePort': '遠端埠 *',
  'pf.wizard.destination.title': '設定目標位址：',
  'pf.wizard.destination.desc.local': '輸入你希望透過 tunnel 存取的遠端目標位址。',
  'pf.wizard.destination.desc.remote': '要轉發流量到的目標位址與埠。',
  'pf.wizard.destination.address': '目標位址 *',
  ...
  'pf.wizard.sshServer.desc.default': '選擇用於將流量 tunnel 到目標位址的 SSH server。',
  ...
  'sftp.dragDropToUpload': '拖曳檔案到這裡上傳',
  'sftp.retry': '重試',
  ...
  'sftp.transferCenter.phase.verifying': '正在驗證',
  ...
  'sftp.transfers.dragToResize': '拖曳調整高度',
  'sftp.goUp': '上一級',
  ...
  'sftp.fileName': '檔案名稱',
  'sftp.fileName.placeholder': '輸入檔案名稱',
  'sftp.prompt.newFolderName': '新增資料夾名稱？',
