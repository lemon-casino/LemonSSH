...
export const ruTerminalMessages: Messages = {
  ...
  'cloudSync.oauth.guide.github': 'GitHub: Настройки → Настройки разработчика → OAuth Apps → New. Любое имя и адрес сайта, без URI перенаправления, включите ’Device Flow’ внизу. Вставьте Client ID сюда.',
