...
export const ruVaultMessages: Messages = {
  ...
  'notes.toolbar.modeLive': 'Живой просмотр',
  'notes.toolbar.modeLiveTitle': 'Режим живого просмотра (WYSIWYG)',
  'notes.toolbar.modeSource': 'Исходный код',
  'notes.toolbar.modeSourceTitle': 'Режим исходного кода (Markdown)',
  'notes.toolbar.modePreview': 'Чтение',
  'notes.toolbar.modePreviewTitle': 'Режим чтения (только для чтения)',
  'notes.toolbar.undo': 'Отменить (Ctrl+Z)',
  'notes.toolbar.redo': 'Повторить (Ctrl+Y)',
  'notes.toolbar.typography': 'Шрифт кода и параметры оформления',
  'notes.toolbar.customCodeFont': 'Пользовательский шрифт кода',
  'notes.toolbar.fontsAvailable': '{count} доступных шрифтов',
  'notes.toolbar.searchFont': 'Поиск шрифтов...',
  'notes.toolbar.noFontsFound': 'Совпадающие моноширинные шрифты не найдены',
  'notes.toolbar.defaultFont': 'Моноширинный по умолчанию (Default)',
  'notes.toolbar.bodyFontSize': 'Размер текста',
  'notes.toolbar.codeFontSize': 'Размер кода',
  'notes.toolbar.headingLevel': 'Уровень заголовка',
  'notes.toolbar.h1': 'Заголовок 1',
  'notes.toolbar.h2': 'Заголовок 2',
  'notes.toolbar.h3': 'Заголовок 3',
  'notes.toolbar.h4': 'Заголовок 4',
  'notes.toolbar.bold': 'Жирный (Ctrl+B)',
  'notes.toolbar.italic': 'Курсив (Ctrl+I)',
  'notes.toolbar.strikethrough': 'Зачёркнутый',
  'notes.toolbar.underline': 'Подчёркнутый',
  'notes.toolbar.inlineCode': 'Встроенный код',
  'notes.toolbar.bulletList': 'Маркированный список',
  'notes.toolbar.orderedList': 'Нумерованный список',
  'notes.toolbar.taskList': 'Список задач',
  'notes.toolbar.quote': 'Цитата',
  'notes.toolbar.codeBlock': 'Блок кода',
  'notes.toolbar.mathFormula': 'Математическая формула (LaTeX / Math)',
  'notes.toolbar.table': 'Вставить таблицу',
  'notes.toolbar.divider': 'Разделитель',
  'notes.toolbar.link': 'Вставить ссылку',
  'notes.toolbar.image': 'Вставить изображение',
  'notes.action.pin': 'Закрепить заметку',
  'notes.action.unpin': 'Открепить заметку',
  'notes.tag.remove': 'Удалить тег',
  'notes.tag.placeholder': 'Имя тега...',
  'notes.tag.add': 'Добавить тег',
  'notes.outline.title': 'Оглавление',
  'notes.outline.titleWithCount': 'Оглавление ({count})',
  'notes.outline.empty': 'Нет заголовков',
  'notes.outline.emptyHint': 'Используйте # и ## в Markdown для создания заголовков',
  'notes.export.share': 'Экспорт и общий доступ',
  'notes.export.currentNote': 'Текущая заметка',
  'notes.export.exportMarkdown': 'Экспорт в Markdown (.md)',
  'notes.export.exportHtml': 'Экспорт в HTML (.html)',
  'notes.export.copyMarkdown': 'Копировать исходный Markdown',
  'notes.export.allNotes': 'Все заметки',
  'notes.export.exportAllZip': 'Экспортировать все в ZIP-архив',
  'notes.export.toast.markdownSuccess': 'Markdown-файл экспортирован',
  'notes.export.toast.htmlSuccess': 'HTML-файл экспортирован',
  'notes.export.toast.zipSuccess': 'Все заметки экспортированы в архив ZIP',
  ...
  'vault.hosts.selectedSummary': 'Выбрано хостов: {hosts}, групп: {groups}',
  ...
  'vault.import.destination.title': 'Куда импортировать хосты?',
  'vault.import.destination.preserve': 'Сохранить исходные группы',
  'vault.import.destination.existing': 'Выбрать группу',
  'vault.import.destination.new': 'Создать группу',
  'vault.import.destination.noGroups': 'Нет доступных групп',
  'vault.import.destination.newPlaceholder': 'Имя новой группы',
  'vault.import.destination.settings': 'Место импорта',
  'vault.import.destination.settingsHint': 'Куда помещать новые хосты',
  'vault.import.destination.done': 'Готово',
  'vault.import.securecrt.directoryHint': 'Выберите папку Sessions из SecureCRT.',
  'vault.import.securecrt.chooseSource': 'Выберите источник импорта SecureCRT.',
  'vault.import.securecrt.sourceQuestion': 'Что вы хотите импортировать?',
  'vault.import.securecrt.promptTitle': 'Импорт из SecureCRT',
  'vault.import.securecrt.promptDesc':
    'Выберите папку Sessions из SecureCRT, чтобы импортировать все сеансы с сохранением структуры, или один файл сеанса .ini.',
  'vault.import.securecrt.folder': 'Папка Sessions',
  ...
  'vault.import.progress.title': 'Импорт хостов',
  'vault.import.progress.reading': 'Чтение файла',
  'vault.import.progress.parsing': 'Обработка хостов',
  'vault.import.progress.preparing': 'Подготовка изменений',
  'vault.import.progress.saving': 'Сохранение хостов',
  ...
  'vault.import.progress.fileSummary': '{name} · файлов: {count}',
  'vault.import.progress.fileCount': 'Обработано {completed} из {total}',
  'vault.import.mobaxterm.chooseEncoding': 'Выберите способ чтения файла MobaXterm.',
  'vault.import.mobaxterm.encodingQuestion': 'Какая кодировка используется в этом файле?',
  'vault.import.mobaxterm.auto': 'Определить автоматически',
  'vault.import.mobaxterm.autoDesc': 'Рекомендуется. UTF-8, если он корректен, иначе китайская кодировка Windows.',
  ...
  'vault.import.sshConfig.managedDestinationHint': 'Управляемая синхронизация всегда использует отдельную группу; выбранная выше группа применяется только к разовому импорту.',
  'vault.import.sshConfig.managedGroup': 'конфигурация SSH',
  ...
  'sftp.context.extract': 'Распаковать здесь',
  'sftp.extract.extracting': 'Распаковка {fileName}...',
  'sftp.extract.success': 'Распакован {fileName}',
  'sftp.extract.error': 'Не удалось распаковать {fileName}: {error}',
  ...
  'sftp.transferCenter.phase.scanning': 'Сканирование',
  'sftp.transferCenter.phase.compressing': 'Сжатие',
  'sftp.transferCenter.phase.uploading': 'Загрузка',
  'sftp.transferCenter.phase.transferring': 'Передача',
  ...
  'sftp.transferCenter.bucket.attention': 'Требует внимания',
  ...
  'sftp.transferCenter.status.pausing': 'Пауза',
  'sftp.transferCenter.status.paused': 'Приостановлено',
  'sftp.transferCenter.status.attention': 'Требует внимания',
  'sftp.transferCenter.status.interrupted': 'Прервано — продолжите вручную',
  'sftp.transferCenter.status.completed': 'Завершено',
  'sftp.transferCenter.status.failed': 'Ошибка',
  'sftp.transferCenter.status.cancelled': 'Отменено',
  'sftp.transferCenter.background': 'Фоновая',
  'sftp.transferCenter.pause': 'Пауза',
  'sftp.transferCenter.resume': 'Продолжить',
  ...
  'sftp.transferCenter.clear': 'Очистить записи',
  'sftp.transferCenter.applyAll': 'Применить ко всем',
  ...
  'sftp.locatePathInTerminal': 'Открыть путь в терминале',
  ...
  'sftp.conflict.folderTitle': 'Конфликт папок',
  'sftp.conflict.folderDesc': 'Выберите действие.',
  'sftp.conflict.folderFileDesc': 'В месте назначения уже существует файл с таким именем. Папку нельзя объединить с файлом.',
  'sftp.conflict.folderSymlinkDesc': 'В месте назначения уже существует символическая ссылка с таким именем. Папку нельзя объединить с символической ссылкой.',
  'sftp.conflict.folderUnknownDesc': 'В месте назначения уже существует элемент с таким именем, но его тип не удалось определить. Замена недоступна для защиты данных в месте назначения.',
  'sftp.conflict.folderMergeHint': 'Объединить: сохранить содержимое, которое есть только в папке назначения.',
  'sftp.conflict.folderReplaceWarning': 'Заменить: удалить содержимое, которое есть только в папке назначения. Это нельзя отменить.',
  ...
  'settings.sftp.transferConcurrency.desc': 'Максимальное число файлов, одновременно передаваемых для одной цели, включая содержимое папок и отдельно выбранные файлы. Большие значения могут ускорить передачу, но перегрузить некоторые серверы.',
  'settings.sftp.transferPoolIdleTtl': 'Удержание transfer-соединений',
  'settings.sftp.transferPoolIdleTtl.desc': 'Как долго простаивающие SFTP-соединения пула передачи остаются открытыми. Большее время снижает задержку перед следующей передачей. Активные передачи не закрываются.',
  'settings.sftp.transferPoolIdleTtl.1m': '1 минута',
  'settings.sftp.transferPoolIdleTtl.5m': '5 минут',
  'settings.sftp.transferPoolIdleTtl.15m': '15 минут',
  'settings.sftp.transferPoolIdleTtl.30m': '30 минут',
  'settings.sftp.transferPoolIdleTtl.never': 'До выхода из приложения',
  'settings.ssh.transportIdleTtl': 'Удержание SSH-соединений',
  'settings.ssh.transportIdleTtl.desc': 'Как долго общее SSH-соединение остаётся открытым после освобождения последнего lease терминала, SFTP-браузера, пакетной передачи или проброса портов. Пока оно тёплое, повторное подключение к тому же хосту может обойти повторную аутентификацию (включая MFA). Активные сессии и передачи не закрываются.',
  'settings.ssh.transportIdleTtl.1m': '1 минута',
  'settings.ssh.transportIdleTtl.5m': '5 минут',
  'settings.ssh.transportIdleTtl.15m': '15 минут',
  'settings.ssh.transportIdleTtl.30m': '30 минут',
  'settings.ssh.transportIdleTtl.never': 'До выхода из приложения',
  ...
  'settings.osProtocol.title': 'Перехват протоколов',
  'settings.osProtocol.enable': 'Открывать ссылки ssh:// и telnet:// в LemonSSH',
  'settings.osProtocol.enableDesc': 'Регистрирует схемы ssh://, telnet:// и netcatty:// для текущего пользователя: ссылки из браузеров и других приложений будут открываться в LemonSSH. Записывает только ветку реестра текущего пользователя; права администратора не нужны.',
  ...
  'quickConnect.knownHost.fingerprintLabel': 'Отпечаток {keyType} — SHA256:',
  ...
  'hostDetails.sftp.fileProtocol': 'Протокол файлов',
  'hostDetails.sftp.fileProtocol.desc': 'Авто сначала пробует SFTP, затем SCP-режим, если подсистема SFTP недоступна. Принудительный SCP — для хостов только с SCP.',
  'hostDetails.sftp.fileProtocol.auto': 'Авто',
  'hostDetails.sftp.fileProtocol.sftp': 'Только SFTP',
  'hostDetails.sftp.fileProtocol.scp': 'Режим SCP',
  ...
  'hostDetails.auth.method': 'Способ входа',
  'hostDetails.auth.auto': 'Автоматически',
  'hostDetails.auth.auto.desc': 'Сначала использовать SSH-агент и локальные ключи, затем сохранённый пароль.',
  'hostDetails.auth.passwordOnly': 'Только пароль',
  'hostDetails.auth.password.desc': 'Использовать только сохранённый пароль и интерактивные запросы пароля.',
  'hostDetails.auth.key': 'Ключ',
  ...
  'hostDetails.section.systemSshAgent': 'Системный SSH-агент',
  'hostDetails.systemSshAgent': 'Использовать системный SSH-агент для входа',
  'hostDetails.systemSshAgent.desc': 'Использовать ключи, разблокированные macOS, Linux, Windows, 1Password или другим совместимым агентом',
  'hostDetails.systemSshAgent.socket': 'Сокет агента',
  'hostDetails.systemSshAgent.socket.desc': 'Оставьте пустым, чтобы использовать SSH_AUTH_SOCK',
  'hostDetails.systemSshAgent.identitiesOnly': 'Только настроенные ключи',
  'hostDetails.systemSshAgent.identitiesOnly.desc': 'Не пробовать другие ключи, загруженные в агент',
  'hostDetails.systemSshAgent.notRunning': 'Системный SSH-агент недоступен',
  'hostDetails.systemSshAgent.notRunningHint': 'Запустите или разблокируйте SSH-агент либо укажите путь к его сокету выше.',
  ...
  'hostDetails.agentForwarding': 'Проброс SSH-агента',
  ...
  'hostDetails.agentForwarding.agentNotRunning': 'SSH-агент недоступен',
  'hostDetails.agentForwarding.agentNotRunningHint': 'SSH-агент не обнаружен. Включите OpenSSH Authentication Agent в службах Windows или используйте совместимый агент, например Bitwarden, 1Password или gpg-agent.',
  'hostDetails.section.agentForwarding': 'SSH-агент',
  ...
  'hostDetails.skipEcdsaHostKey': 'Пропустить ключ хоста ECDSA',
  ...
  'hostDetails.algorithms.category.serverHostKey': 'Ключ хоста',
  'hostDetails.algorithms.category.compress': 'Сжатие',
  'hostDetails.section.keepalive': 'Поддержание соединения',
  ...
  'hostDetails.jumpHosts.hops': 'Переходов: {count}',
  ...
  'hostDetails.proxyPanel.test': 'Проверить соединение',
  'hostDetails.proxyPanel.test.testing': 'Проверка…',
  'hostDetails.proxyPanel.test.ok': 'Прокси доступен ({ms} мс)',
  'hostDetails.proxyPanel.test.failed': 'Проверка прокси не удалась: {error}',
  ...
  'hostDetails.plugin.title': 'Подключение плагина',
  'hostDetails.plugin.provider.placeholder': 'Выберите провайдер подключения',
  'hostDetails.plugin.provider.empty': 'Провайдеры подключения не установлены',
  'hostDetails.plugin.authentication.placeholder': 'Выберите провайдер аутентификации',
  'hostDetails.plugin.authentication.none': 'Управляется провайдером или не требуется',
  'hostDetails.plugin.credential.placeholder': 'Выберите учётные данные хоста',
  'hostDetails.plugin.credential.none': 'Без сохранённых учётных данных',
  'hostDetails.plugin.credential.password': 'Пароль профиля',
  'hostDetails.plugin.credential.privateKey': 'Закрытый ключ',
  'hostDetails.plugin.credential.unavailable': 'Сохранённые учётные данные недоступны',
  'hostDetails.plugin.configuration.label': 'Конфигурация провайдера (JSON)',
  'hostDetails.plugin.configuration.invalid': 'Конфигурация должна быть допустимым JSON.',
  'hostDetails.plugin.configuration.schemaInvalid': 'Конфигурация не соответствует схеме провайдера.',
  'hostDetails.plugin.unavailable': 'Настроенный провайдер недоступен. Конфигурация сохранится до восстановления плагина.',
  'hostDetails.plugin.useSsh': 'Использовать SSH',
  ...
  'vault.import.plugins.title': 'Импортёры плагинов',
  'vault.import.plugins.loading': 'Создание безопасного предварительного просмотра…',
  'vault.import.plugins.progress': 'Обработано {completed} из {total} {message}',
  'vault.import.plugins.preview': 'Предварительный просмотр импорта',
  'vault.import.plugins.empty': 'Импортёр не вернул доступных черновиков.',
  'vault.import.plugins.summary': 'Черновики: {parsed} · предупреждения: {warnings} · ошибки: {errors}',
  'vault.import.plugins.commit': 'Импортировать предварительный просмотр',
  'vault.import.plugins.fileUnavailable': 'Мост настольного импортёра не может получить доступ к выбранному файлу.',
  'vault.import.plugins.notRecognized': 'Этот импортёр не распознал выбранный файл.',
  'vault.import.plugins.containsErrors': 'Предварительный просмотр содержит ошибки и не может быть применён.',
  'vault.import.plugins.committed': 'Импортировано проверенных элементов: {count}.',
  'vault.import.plugins.duplicates': 'Дубликаты будут пропущены: {count}.',
  'vault.import.plugins.validationErrors': 'Черновики не прошли проверку хоста: {count}. Импортёр должен исправить их.',
  'vault.import.plugins.kind.host': 'Хост',
  'vault.import.plugins.kind.identity': 'Учётные данные',
  'vault.import.plugins.kind.key': 'Ключ',
  'vault.import.plugins.kind.snippet': 'Сниппет',
  'vault.import.plugins.kind.group': 'Группа',
  'vault.import.plugins.moreItems': 'В импорт включено ещё элементов: {count}.',
  'vault.import.plugins.moreDiagnostics': 'В предварительном просмотре скрыто ещё сообщений: {count}.',
