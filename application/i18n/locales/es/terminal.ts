...
export const esTerminalMessages: Messages = {
  ...
  'cloudSync.gate.warning':
    'Entiendo que debo guardar la clave maestra y los ID de cliente OAuth en un lugar seguro. Si olvido la clave maestra, puedo usar Reiniciar para empezar de nuevo: los datos locales de la bóveda se conservan, pero se borran los ID de cliente, las conexiones de proveedores y la identidad de sincronización, así que tendré que volver a pegar los ID de cliente.',
  ...
  'cloudSync.oauth.guide.google': '1. Abre el mismo proyecto en console.cloud.google.com.\n2. Biblioteca → habilita Google Drive API.\n3. Deja la pantalla de consentimiento en Pruebas; añade tu Gmail en Audience como usuario de prueba.\n4. Data Access: añade drive.appdata, userinfo.email, userinfo.profile.\n5. Credenciales → Crear ID de cliente OAuth → Aplicación de escritorio.\n6. Pega el ID arriba y el client_secret (GOCSPX-) del JSON en el campo de secreto.\n7. Conecta otra vez desde LemonSSH; no recargues una pestaña vieja de 127.0.0.1.',
  ...
  'cloudSync.unlock.forgotLink': '¿Olvidaste tu clave maestra?',
  'cloudSync.unlock.forgotConfirmDesc': 'Restablecer la sincronización elimina la clave maestra guardada, réplicas, bases, conexiones de proveedores e ID de cliente OAuth. Tus datos locales no se tocan, pero la próxima sincronización empieza de cero con una nueva clave maestra. No se puede deshacer.',
  'cloudSync.unlock.forgotConfirmButton': 'Restablecer sincronización',
  'cloudSync.unlock.forgotCancel': 'Conservarla',
  'cloudSync.unlock.forgotDoneToast': 'Sincronización restablecida ({{count}} entradas eliminadas). Define una nueva clave maestra para empezar de nuevo.',
  'cloudSync.unlock.forgotFailed': 'Error al restablecer la sincronización',
  'cloudSync.resetInit.button': 'Reiniciar',
  'cloudSync.resetInit.title': '¿Reiniciar la sincronización?',
  'cloudSync.resetInit.desc': '¿Olvidaste tu clave maestra? Reiniciar la sincronización borra su identidad para empezar de nuevo con una nueva clave maestra.',
  'cloudSync.resetInit.itemKey': 'Elimina la clave maestra guardada y su verificador',
  'cloudSync.resetInit.itemConnections': 'Elimina conexiones de proveedores, réplicas, bases e instantáneas',
  'cloudSync.resetInit.itemOAuth': 'Elimina los ID de cliente OAuth guardados',
  'cloudSync.resetInit.itemLocalSafe': 'Tus datos locales no se tocan; no se puede deshacer',
  'cloudSync.oauth.sectionDesc': 'Registra un cliente OAuth de tipo aplicación de escritorio para cada proveedor y pega su ID de cliente aquí. Los clientes de escritorio de Google incluyen un client_secret en el JSON descargado; también hay que pegarlo para el intercambio de tokens. GitHub usa Device Flow; OneDrive usa PKCE con redirección de bucle local.',
  'cloudSync.oauth.github': 'ID de cliente de GitHub',
  'cloudSync.oauth.google': 'ID de cliente de Google',
  'cloudSync.oauth.googleSecret': 'Secreto de cliente de Google',
  'cloudSync.oauth.googleSecretHint': 'Copia client_secret (empieza por GOCSPX-) del JSON de la aplicación de escritorio. Se queda en este dispositivo y solo se usa para intercambiar tokens.',
  'cloudSync.oauth.onedrive': 'ID de cliente de OneDrive',
