...
export const esTerminalMessages: Messages = {
  ...
  'cloudSync.unlock.forgotConfirmDesc': 'Restablecer la sincronización elimina la clave maestra guardada, réplicas, bases y conexiones de proveedores. Tus datos locales no se tocan, pero la próxima sincronización empieza de cero con una nueva clave maestra. No se puede deshacer.',
